...
final _entities = <ModelEntity>[
  ModelEntity(
      id: const IdUid(1, 376350780357401324),
      name: 'Group',
      lastPropertyId: const IdUid(3, 5955273839101246551),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 1220897563864871310),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 1307387915830672771),
            name: 'name',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 5955273839101246551),
            name: 'color',
            type: 6,
            flags: 0)
      ],
  ...
  ModelEntity(
      id: const IdUid(2, 4050153206109435058),
      name: 'Task',
      lastPropertyId: const IdUid(4, 3207762905435088617),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 9118094796364536483),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 5332629596826128959),
            name: 'description',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 7184785255018834565),
            name: 'completed',
            type: 1,
            flags: 0),
        ModelProperty(
            id: const IdUid(4, 3207762905435088617),
            name: 'groupId',
            type: 11,
            flags: 520,
            indexId: const IdUid(1, 5221354741306268777),
...
ModelDefinition getObjectBoxModel() {
  final model = ModelInfo(
      entities: _entities,
      lastEntityId: const IdUid(2, 4050153206109435058),
      lastIndexId: const IdUid(1, 5221354741306268777),
